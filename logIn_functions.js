   ...
   if(logged_in=="false"){
     ...
     +"               <button type=\"button\" class=\"btn btn-secondary\" onclick=\"verify()\">sign up</button> </div></div></div>";
      ...
      nav.innerHTML += "<div class=\"dropdown\" id=\"log_in_dropdown\">"
       + "<img src=\"https://upload.wikimedia.org/wikipedia/commons/8/89/Portrait_Placeholder.png\" class=\"rounded-circle\" id=\"profile_photo\" width=\"50\" data-toggle=\"dropdown\" height=\"50\" style=\"margin:0px 20px\">"
       + "<div class=\"dropdown-menu dropdown-menu-right px-1\" style=\"background-color:#E84B0E;color:white\">"
